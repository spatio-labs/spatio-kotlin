...
class AgentTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of Agent
        //val modelInstance = Agent()
        ...
        // to test the property `isPreconfigured`
        should("test isPreconfigured") {
            // uncomment below to test the property
            //modelInstance.isPreconfigured shouldBe ("TODO")
        }
